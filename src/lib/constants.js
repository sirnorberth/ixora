...
export const CHALLENGE_STATUSES = ["Open", "In progress", "Delayed", "Done"];

export const CHALLENGE_STATUS_STYLES = {
  "Open": { bg: "bg-blue-100", text: "text-blue-700", dot: "bg-blue-500" },
  "In progress": { bg: "bg-orange-100", text: "text-orange-700", dot: "bg-orange-500" },
  "Delayed": { bg: "bg-amber-100", text: "text-amber-700", dot: "bg-amber-500" },
  "Done": { bg: "bg-emerald-100", text: "text-emerald-700", dot: "bg-emerald-500" },
};
