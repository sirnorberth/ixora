...
var ScrollAreaScrollbar = /* @__PURE__ */ React2.forwardRef(
  ...
  /* @__PURE__ */ __name(function ScrollAreaScrollbar2(props, forwardedRef) {
    ...
    return context.type === ScrollAreaType.Hover ? /* @__PURE__ */ jsx(ScrollAreaScrollbarHover, { ...scrollbarProps, ref: forwardedRef, forceMount }) : context.type === ScrollAreaType.Scroll ? /* @__PURE__ */ jsx(ScrollAreaScrollbarScroll, { ...scrollbarProps, ref: forwardedRef, forceMount }) : context.type === ScrollAreaType.Auto ? /* @__PURE__ */ jsx(ScrollAreaScrollbarAuto, { ...scrollbarProps, ref: forwardedRef, forceMount }) : context.type === ScrollAreaType.Always ? /* @__PURE__ */ jsx(ScrollAreaScrollbarVisible, { ...scrollbarProps, ref: forwardedRef, "data-state": "visible" }) : null;
  }, "ScrollAreaScrollbar")
);
...
var ScrollAreaScrollbarY = /* @__PURE__ */ React2.forwardRef(/* @__PURE__ */ __name(function ScrollAreaScrollbarY2(props, forwardedRef) {
  ...
  return /* @__PURE__ */ jsx(
    ScrollAreaScrollbarImpl,
    {
      ...
      style: {
        top: 0,
        right: context.dir === Direction.LTR ? 0 : void 0,
        left: context.dir === Direction.RTL ? 0 : void 0,
...
function getScrollPositionFromPointer(pointerPos, pointerOffset, sizes, dir = Direction.LTR) {
...
function getThumbOffsetFromScroll(scrollPos, sizes, dir = Direction.LTR) {
  const thumbSizePx = getThumbSize(sizes);
  const scrollbarPadding = sizes.scrollbar.paddingStart + sizes.scrollbar.paddingEnd;
